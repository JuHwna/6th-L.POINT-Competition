...
![image](https://user-images.githubusercontent.com/49123169/79784848-d8d1cc00-837d-11ea-8a35-71c314d48543.png)

- 따라서 이 모델을 채택하여 본선 발표 때 사용했습니다.


## 7. 공모전 결과
- 예선에 참가한 300여개의 팀 중에서 본선 진출 팀으로 뽑혔습니다.(총 8팀)
- 본선이 발표로 진행되어 2주 동안 내용을 더 보충하고 ppt 장수를 줄였습니다.
- 본선에 발표했을 때, 괜찮은 평가를 받았습니다.
- 최종 결과 : **우수상**

## 8. 공모전으로부터 얻은 것들
- 데이터 분석 프로젝트에서 적극적인 대화가 매우 중요하다는 사실을 깨달았습니다.
  - 분석 과정과 결과를 계속 팀원들과 이야기를 나누면서 부족한 점이나 색다른 방식들을 알아내어 더 보완할 수 있었습니다.
- 모델을 생각할 때는 일단 칠판에 적어서 생각하는 습관을 길러야 되겠다는 생각이 들었습니다.
  - 단순히 읽었을 때랑 확실히 다르다는 느낌을 받았습니다.
- 모델 개발 시, 여러 논문을 읽어야 주어진 데이터에 알맞은 모델을 찾을 수 있다는 것을 깨달았습니다.
- 비즈니스 전략을 제안에 대한 아이디어가 매우 중요하다는 것을 알 수 있었습니다.
  - 단순한 전략보다는 확실히 분석 결과를 통해 적절하고 기발한 아이디어가 필요함을 느꼈습니다.
- 기술적인 부분
  - 해본 적이 없는 임베딩해볼 수 있었습니다. (이 영향으로 NLP 공부를 진행했습니다.)
  - tensorflow 1 버전을 어느 정도 쓸 수 있게 되었습니다.
  - 추천 모델에 대한 여러 방법들을 알고 습득할 수 있었습니다.
  - 이외에 시각화, 크롤링 등 여러 코딩들을 복습할 수 있는 좋은 기회였습니다.
  
## 9. 느낀 점
- 로그 데이터를 더 분석해보고 싶은 생각이 들었습니다.
- 고객 행동에 대해 분석하는 것에 재미를 느낄 수 있었습니다.

[![Hits](https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Fgithub.com%2FJuHwna%2F6th-LPOINT-Competition&count_bg=%2379C83D&title_bg=%23555555&icon=&icon_color=%23E7E7E7&title=hits&edge_flat=false)](https://hits.seeyoufarm.com)
